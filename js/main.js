const replacements_id = {
    ...
    "showentityfamily": "показатисімействосутности",
    "notshowbeitemforms": "непоказуватиформипредмета",
    "entityfamily": "сімействосутности",
...
const replacements_biome = {
    ...
    "dryfoliagecolor": "колірсухоголистя",
    "foliagecolor": "колірлистя",
    "watercolor": "колірводи",
    "underwaterfogdistance": "відстаньпідводноготуману",
    "atmospherics": "атмосфера",
    "lighting": "освітлення",
    "volumetric": "об'ємний",
    "colorgrading": "кольорокорекція",
