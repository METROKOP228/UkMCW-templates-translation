...
if (localStorage.getItem('cookieConsent') && localStorage.getItem('loadJava') === "major") {
    versJson = [ "1.21.6", "1.20.6", "1.19.4", "1.18.2", "1.17.1", "1.16.5", "1.15.2", "1.14.4", "1.13.2" ]
    ...
    versJson = 
        [ "1.21.6", "1.21.5", "1.21.4", "1.21.3", "1.21.1", "1.21", "1.20.6", "1.20.5", "1.20.4", "1.20.3", "1.20.2", "1.20.1",
