...
if (localStorage.getItem('cookieConsent') && localStorage.getItem('loadJava') === "major") {
    versJson = [ "1.21.11", "1.20.6", "1.19.4", "1.18.2", "1.17.1", "1.16.5", "1.15.2", "1.14.4", "1.13.2" ]
    ...
    versJson = 
        ["1.21.11", "1.21.10", "1.21.9", "1.21.8", "1.21.7", "1.21.6", "1.21.5", "1.21.4", "1.21.3", "1.21.1", "1.21", "1.20.6", "1.20.5", "1.20.4", "1.20.3",
...
let versBedrock = ["v1.21.130.3", "v1.21.120.4", "v1.21.110.2", "v1.21.100.6", "v1.21.90.3", "v1.21.80.3", "v1.21.70.3",
