...
if (localStorage.getItem('cookieConsent') && localStorage.getItem('loadJava') === "major") {
    versJson = [ "26.2", "26.1", "1.21.11", "1.20.6", "1.19.4", "1.18.2", "1.17.1", "1.16.5", "1.15.2", "1.14.4", "1.13.2" ]
    ...
    versJson = 
        [ "26.2", "26.1", "1.21.11", "1.21.10", "1.21.9", "1.21.8", "1.21.7", "1.21.6", "1.21.5", "1.21.4", "1.21.3", "1.21.1", "1.21", "1.20.6", "1.20.5", "1.20.4", "1.20.3",
...
let versBedrock = [ "v1.26.40.05", "v1.26.30.5", "v1.26.20.4", "v1.26.10.4", "v1.21.130.3", "v1.21.120.4", "v1.21.110.2", "v1.21.100.6", "v1.21.90.3", "v1.21.80.3", "v1.21.70.3",
                   "v1.21.60.10", "v1.21.50.7", "v1.21.40.3", "v1.21.30.3", "v1.21.20.3", "v1.21.0.3", "v1.20.80.5", "v1.20.70.6",
                   "v1.20.50.3", "v1.20.40.1", "v1.20.30.1", "v1.20.10.1", "v1.20.0.1", "v1.19.80.2", "v1.19.70.2",
                   "v1.20.60.4", "v1.19.60.3", "v1.19.50.2", "v1.19.40.2", "v1.19.30" ];
